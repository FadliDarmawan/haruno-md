...
//=============Template============//
  conn.sendTemplateLoc = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, urlb3, url3, callb1, call1, quoted) => {
  ...
  conn.sendTemplateButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
  ...
  conn.send2TemplateButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
  ...
  conn.send3TemplateButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
  ...
  conn.sendTemplate2UrlButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
  ...
  conn.send2Template2UrlButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, buttons2, row2, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
  ...
  conn.send3Template2UrlButtonLoc = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { generateWAMessageFromContent, proto } = require('@adiwajshing/baileys-md')
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
...
* @param {Object} options 
*/
  conn.sendTemplateButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, quoted) => {
  ...
  conn.send2TemplateButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ image: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
          imageMessage: hiro.imageMessage,
          hydratedContentText: contentText,
          hydratedFooterText: footer,
          hydratedButtons: [{
            urlButton: {
  ...
  conn.send3TemplateButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ image: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
...
* @param {Object} options 
*/
  conn.sendTemplate2UrlButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, quoted) => {
  ...
  conn.send2Template2UrlButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, buttons2, row2, quoted) => {
    const { generateWAMessageFromContent, prepareWAMessageMedia, proto } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ image: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.send3Template2UrlButtonImg = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { generateWAMessageFromContent, prepareWAMessageMedia, proto } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ image: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.sendTemplateButtonVid = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
        hydratedTemplate: {
          videoMessage: hiro.videoMessage,
          hydratedContentText: contentText,
          hydratedFooterText: footer,
          hydratedButtons: [{
            urlButton: {
  ...
  conn.send2TemplateButtonvid = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.send3TemplateButtonVid = async (jid, buffer, contentText, footer, urlb1, url1, callb1, call1, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.sendTemplate2UrlButtonVid = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.send2Template2UrlButtonVid = async (jid, buffer, contentText, urlb1, url1, urlb2, url2, buffer, buttons1, row1, buttons2, row2, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
  ...
  conn.send3Template2UrlButtonVid = async (jid, buffer, contentText, footer, urlb1, url1, urlb2, url2, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
    const { default: makeWASocket, generateWAMessageFromContent, proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
    const hiro = await prepareWAMessageMedia({ video: buffer }, { upload: conn.waUploadToServer })
    const template = generateWAMessageFromContent(quoted.key.remoteJid, proto.Message.fromObject({
      templateMessage: {
